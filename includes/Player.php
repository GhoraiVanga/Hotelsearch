...
class Player extends Database
{
    ...
    public function getRows($start = 0, $limit = 50)
    {
    ...
    public function searchPlayer($searchText, $start = 0, $limit = 10000000)
    {
        $sql = "SELECT * FROM {$this->tableName} WHERE city LIKE :search ORDER BY id  ASC LIMIT {$start},{$limit}";
        $stmt = $this->conn->prepare($sql);
